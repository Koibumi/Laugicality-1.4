    ...
    public class LaugicalityGlobalProjectile : GlobalProjectile
    {
        ...
        public override bool PreAI(Projectile projectile)
        {
            ...
            if (projectile.type == ProjectileID.StardustGuardian || projectile.type == ProjectileID.StardustGuardianExplosion)
                projectile.damage = (int)(2000 * Main.player[projectile.owner].GetDamage(DamageClass.Summon).Additive);
        ...
        public override void OnHitNPC(Projectile projectile, NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            if(!modPlayer.NoDebuffDamage)
                InflictDebuffs(projectile, target, hit.Damage, hit.Knockback, hit.Crit);
        }

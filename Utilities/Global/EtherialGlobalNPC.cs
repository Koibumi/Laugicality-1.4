...
using Laugicality.Content.NPCs.Etherial.BossFights;
...
{
    class EtherialGlobalNPC : GlobalNPC, ILocalizedModType
    {
        public string LocalizationCategory => "EtherialGlobalNPCSystem";
        public override void Load()
        {
            string Etherial = this.GetLocalization("Chat.Etherial").Value; // Steampunk Slimes are falling from the sky!
        }
        ...
        private void ScaleSpecificEtherialStats(NPC npc)
        {
            ...
            if (npc.type == ModContent.NPCType<DuneSharkron>())
            {
                npc.damage = 200;
                npc.lifeMax = 80000;
                npc.life = npc.lifeMax;
            ...
            if (npc.type == ModContent.NPCType<Hypothema>())
            {
                npc.damage = 200;
                npc.lifeMax = 70000;
                npc.life = npc.lifeMax;
            ...
            if (npc.type == ModContent.NPCType<Ragnar>())
            {
                npc.damage = 250;
                npc.lifeMax = 100000;
                npc.life = npc.lifeMax;
            ...
            if (npc.type == ModContent.NPCType<Dioritus>())
            {
                npc.damage = 250;
                npc.lifeMax = 50000;
                npc.life = npc.lifeMax;
            ...
            if (npc.type == ModContent.NPCType<Andesia>())
            {
                npc.damage = 250;
                npc.lifeMax = 50000;
                npc.life = npc.lifeMax;
            ...
            if (npc.type == ModContent.NPCType<AnDio3>())
            {
                npc.damage = 250;
                npc.lifeMax = 120000;
                npc.life = npc.lifeMax;
            ...
            if (npc.type == NPCID.Spazmatism || npc.type == NPCID.Retinazer || npc.type == ModContent.NPCType<Terratome>())
            {
                npc.damage = 275;
                npc.lifeMax = 150000;
                npc.life = npc.lifeMax;
            ...
            if (npc.type == ModContent.NPCType<TheAnnihilator>())
            {
                npc.damage = 300;
                npc.lifeMax = 225000;
                npc.life = npc.lifeMax;
            ...
            if (npc.type == ModContent.NPCType<SuperMechanicalMinion>() || npc.type == ModContent.NPCType<SuperMechanicalCrawler>() || npc.type == ModContent.NPCType<MechanicalCrawler>() || npc.type == ModContent.NPCType<MechanicalMimic>() || npc.type == ModContent.NPCType<MechanicalShelly>() || npc.type == ModContent.NPCType<MechanicalSlimer>() || npc.type == ModContent.NPCType<MechanicalCreeper>())
            {
                npc.damage = 200;
                npc.lifeMax = 20000;
                npc.life = npc.lifeMax;
            ...
            if (npc.type == ModContent.NPCType<Content.NPCs.Slybertron.Slybertron>())
            {
                npc.damage = 250;
                npc.lifeMax = 250000;
                npc.life = npc.lifeMax;
            ...
            if (npc.type == ModContent.NPCType<GearSlime>() || npc.type == ModContent.NPCType<SparkSlime>() || npc.type == ModContent.NPCType<PipeSlime>())
            {
                npc.damage = 250;
                npc.lifeMax = 20000;
                npc.life = npc.lifeMax;
            ...
            if (npc.type == ModContent.NPCType<Content.NPCs.SteamTrain.SteamTrain>())
            {
                npc.damage = 275;
                npc.lifeMax = 200000;
                npc.life = npc.lifeMax;
            ...
            if (npc.type == NPCID.GolemFistLeft || npc.type == NPCID.GolemFistRight || npc.type == ModContent.NPCType<SuperGolemFist>())
            {
                npc.damage = 300;
                npc.lifeMax = 175000;
                npc.life = npc.lifeMax;
            ...
            if (npc.type == ModContent.NPCType<EtherialEoC>())
            {
                npc.damage = 300;
                npc.lifeMax = 300000;
                npc.life = npc.lifeMax;
            ...
            if (npc.type == ModContent.NPCType<SuperServant>() && NPC.CountNPCS(NPCID.MoonLordCore) > 0)
            {
                npc.damage = 200;
                npc.lifeMax = 50000;
                npc.life = npc.lifeMax;
        ...
        public void EtherialPostAI(NPC npc)
        {
            if (LaugicalityWorld.downedEtheria)
            {
                ...
                if (npc.type == ModContent.NPCType<SuperMechanicalCrawler>())
                {
                ...
                if (npc.type == NPCID.MoonLordFreeEye)
                {
                    if (!_spawnCheck)
                    {
                        ...
                        if (Main.netMode != 1)
                        {
                            NPC.NewNPC(npc.GetSource_FromThis(), (int)npc.Center.X, (int)npc.Center.Y, ModContent.NPCType<EtherialEoC>());
                        }
                    }
                }
                if (npc.type == ModContent.NPCType<EtherialEoC>())
        ...
        private void KingSlimeHealthEffect(NPC npc)
        {
            if (npc.life < (int)(npc.lifeMax - (npc.lifeMax / 10 * (_phase + 1))))
            {
                ...
                if (Main.netMode != 1)
                {
                    int n = NPC.NewNPC(npc.GetSource_FromThis(), (int)npc.Center.X, (int)npc.Center.Y, ModContent.NPCType<SuperSlime>());
                    Main.npc[n].ai[0] = npc.whoAmI;
                    Main.npc[n].ai[1] = NPC.CountNPCS(ModContent.NPCType<SuperSlime>());
                }
            }
        }
        ...
        private void EyeofCthulhuHealthEffect(NPC npc)
        {
            if (npc.life < (int)(npc.lifeMax - (npc.lifeMax / 20 * (_phase + 1))) && npc.life > npc.lifeMax / 2)
            {
                ...
                if (Main.netMode != 1)
                {
                    int n = NPC.NewNPC(npc.GetSource_FromThis(), (int)npc.Center.X, (int)npc.Center.Y, ModContent.NPCType<SuperServant>());
                    Main.npc[n].ai[0] = npc.whoAmI;
                    Main.npc[n].ai[1] = NPC.CountNPCS(ModContent.NPCType<SuperServant>());
                }
            }
            if (npc.life < 30000)
            {
        ...
        private void DuneSharkronHealthEffect(NPC npc)
        {
            if (npc.life < npc.lifeMax / 3 && NPC.CountNPCS(NPCID.SandElemental) < 1)
            {
                _phase++;
                if (Main.netMode != 1)
                    NPC.NewNPC(npc.GetSource_FromThis(), (int)npc.Center.X, (int)npc.Center.Y, NPCID.SandElemental);
            }
        }
        ...
        private void BrainOfCthulhuHealthEffect(NPC npc)
        {
            if (npc.life < (int)(npc.lifeMax - (npc.lifeMax / 10 * (_phase + 1))))
            {
                ...
                if (Main.netMode != 1)
                {
                    int n = NPC.NewNPC(npc.GetSource_FromThis(), (int)npc.Center.X, (int)npc.Center.Y, ModContent.NPCType<SuperIchorSpitter>());
                    Main.npc[n].ai[0] = npc.whoAmI;
                    Main.npc[n].ai[1] = NPC.CountNPCS(ModContent.NPCType<SuperIchorSpitter>());
                }
            }
        }
            ...
            if (_counter > 1 * 60 + (int)(60 * (npc.life / npc.lifeMax)))
            {
                ...
                if (Main.netMode != 1)
                {
                    if (Main.rand.Next(2) == 0)
                        ...
                        NPC.NewNPC(npc.GetSource_FromThis(), (int)npc.Center.X, (int)npc.Center.Y, ModContent.NPCType<SuperBee>());
                }
            }
            if (_counter2 > 4 * 60 + (int)(2 * 60 * (npc.life / npc.lifeMax)))
            {
                _counter2 = 0;
                if (Main.netMode != 1 && NPC.CountNPCS(ModContent.NPCType<SuperHornet>()) < 8)
                    NPC.NewNPC(npc.GetSource_FromThis(), (int)npc.Center.X, (int)npc.Center.Y, ModContent.NPCType<SuperHornet>());
            }
        }
        ...
        private void SpawnArms(NPC npc)
        {
            for (int i = 0; i < 4; i++)
            {
                if (Main.netMode != 1)
                {
                    int n = NPC.NewNPC(npc.GetSource_FromThis(), (int)npc.Center.X, (int)npc.Center.Y, ModContent.NPCType<RagnarHand>());
                    Main.npc[n].ai[0] = i;
        ...
        private void RagnarHealthEffects(NPC npc)
        {
            if (npc.life < (int)(npc.lifeMax * (3 - (_phase + 1)) / 3))
            {
                _phase++;
                if (Main.netMode != 1)
                    NPC.NewNPC(npc.GetSource_FromThis(), (int)npc.Center.X, (int)npc.Center.Y, ModContent.NPCType<LavaTitan>());
            }
        }
        ...
        private void SkeletronAI(NPC npc)
        {
            ...
            {
                if (Main.netMode != 1)
                    NPC.NewNPC(npc.GetSource_FromThis(), (int)npc.Center.X, (int)npc.Center.Y, NPCID.DungeonGuardian);
            }
        }
        ...
        private void AnDioAI(NPC npc)
        {
            ...
            if (_counter > 16 * 60)
            {
                ...
                SoundEngine.PlaySound(new SoundStyle("Laugicality/Sounds/zaWarudo"), npc.position);
            }
        }
        ...
        {
            _counter2++;
            if (_counter2 > (NPC.CountNPCS(ModContent.NPCType<SuperLeechHead>()) + 2) * 60)
            {
                _counter2 = 0;
                if (NPC.CountNPCS(ModContent.NPCType<SuperLeechHead>()) < 10 && Main.netMode != 1)
                {
                    NPC.NewNPC(npc.GetSource_FromThis(), (int)npc.Center.X, (int)npc.Center.Y, ModContent.NPCType<SuperLeechHead>());
                }
            }
        }
        ...
        private void RetinazerAI(NPC npc)
        {
            if (!_spawnCheck)
            {
                if (Main.netMode != 1)
                {
                    NPC.NewNPC(npc.GetSource_FromThis(), (int)npc.Center.X, (int)npc.Center.Y, ModContent.NPCType<Terratome>());
                }
                _spawnCheck = true;
            }
        ...
        private void SkeletronPrimeAI(NPC npc)
        {
            if (!_spawnCheck)
            {
                if (Main.netMode != 1)
                {
                    NPC.NewNPC(npc.GetSource_FromThis(), (int)npc.Center.X, (int)npc.Center.Y, ModContent.NPCType<MechanicalDungeonGuardian>());
                }
                _spawnCheck = true;
            }
        }
        ...
        private void DestroyerAI(NPC npc)
        {
            ...
            if (_counter >= 5)
            {
                ...
                newVel.Normalize();
                newVel *= 12;
                Projectile.NewProjectile(npc.GetSource_FromThis(), npc.Center, newVel, ProjectileID.DeathLaser, npc.damage / 3, 5);
            }
        }
        ...
        private void AnnihilatorAI(NPC npc)
        {
            ...
            DespawnCheck(npc);
            _counter++;
            if (_counter > (NPC.CountNPCS(ModContent.NPCType<SuperMechanicalMinion>()) + 2) * 60)
            {
                _counter = 0;
                int n = NPC.NewNPC(npc.GetSource_FromThis(), (int)npc.Center.X, (int)npc.Center.Y, ModContent.NPCType<SuperMechanicalMinion>());
                Main.npc[n].ai[0] = npc.whoAmI;
                int m = NPC.NewNPC(npc.GetSource_FromThis(), (int)npc.Center.X, (int)npc.Center.Y, ModContent.NPCType<SuperMechanicalCrawler>());
        ...
        private void SlybertronAI(NPC npc)
        {
            if (!_spawnCheck)
            {
                string Etherial = this.GetLocalization("Chat.Etherial").Value;
                Main.NewText(Etherial, 230, 200, 40);
                _spawnCheck = true;
            }
            if (Main.rand.Next(2 * 60) == 0)
            {
                ...
                if (rand == 0)
                {
                    int n = NPC.NewNPC(npc.GetSource_FromThis(), (int)Main.player[npc.target].Center.X - 200 + Main.rand.Next(400), (int)Main.player[npc.target].Center.Y - 500, ModContent.NPCType<GearSlime>());
                }
                if (rand == 1)
                {
                    int n = NPC.NewNPC(npc.GetSource_FromThis(), (int)Main.player[npc.target].Center.X - 200 + Main.rand.Next(400), (int)Main.player[npc.target].Center.Y - 500, ModContent.NPCType<PipeSlime>());
                }
                if (rand == 2)
                {
                    int n = NPC.NewNPC(npc.GetSource_FromThis(), (int)Main.player[npc.target].Center.X - 200 + Main.rand.Next(400), (int)Main.player[npc.target].Center.Y - 500, ModContent.NPCType<SparkSlime>());
                }
            }
            if (npc.life < npc.lifeMax / 2)
            {
        ...
        private void PlanteraAI(NPC npc)
        {
            ...
            if ((_counter > 30 && npc.life > npc.lifeMax / 2) || (_counter > 15 && npc.life <= npc.lifeMax / 2))
            {
                ...
                if (Main.netMode != 1)
                {
                    ...
                    Projectile.NewProjectile(npc.GetSource_FromThis(), npc.Center.X, npc.Center.Y, (float)Math.Cos(_theta) * mag, (float)Math.Sin(_theta) * mag, ModContent.ProjectileType<EtherialSpore>(), (int)(npc.damage * .5), 3, Main.myPlayer);
                    _theta = (float)Math.PI * 2 * Main.rand.NextFloat();
                    if (npc.life <= npc.lifeMax / 2)
                        Projectile.NewProjectile(npc.GetSource_FromThis(), npc.Center.X, npc.Center.Y, (float)Math.Cos(_theta) * mag, (float)Math.Sin(_theta) * mag, ModContent.ProjectileType<EtherialSpore>(), (int)(npc.damage * .5), 3, Main.myPlayer);
                }
        ...
        private void GolemAI(NPC npc)
        {
            if (!_spawnCheck)
            {
                ...
                if (Main.netMode != 1)
                {
                    int n = NPC.NewNPC(npc.GetSource_FromThis(), (int)npc.Center.X, (int)npc.Center.Y, ModContent.NPCType<SuperGolemFist>());
                    Main.npc[n].ai[0] = npc.whoAmI;
                    Main.npc[n].ai[1] = -1;
                    int m = NPC.NewNPC(npc.GetSource_FromThis(), (int)npc.Center.X, (int)npc.Center.Y, ModContent.NPCType<SuperGolemFist>());
                    Main.npc[m].ai[0] = npc.whoAmI;
                    Main.npc[m].ai[1] = 1;
                }
            }
        ...
        {
            _counter2++;
            if (_counter2 > ((NPC.CountNPCS(ModContent.NPCType<SuperShark>()) + 1) * 8) * 60)
            {
                _counter2 = 0;
                if (_movementCounter == 0)
                    ...
                    _movementCounter = 1;
                if (NPC.CountNPCS(ModContent.NPCType<SuperShark>()) < 5 && Main.netMode != 1)
                {
                    int n = NPC.NewNPC(npc.GetSource_FromThis(), (int)npc.Center.X, (int)npc.Center.Y, ModContent.NPCType<SuperShark>());
                    Main.npc[n].ai[0] = npc.whoAmI;
        ...
        public override void OnHitPlayer(NPC npc, Player player, Player.HurtInfo hurtInfo)
        {
            if (LaugicalityWorld.downedEtheria)
            {
                ...
                if (npc.type == ModContent.NPCType<TheAnnihilator>() || 
                    npc.type == ModContent.NPCType<MechanicalCrawler>() || 
                    npc.type == ModContent.NPCType<MechanicalMimic>() || 
                    npc.type == ModContent.NPCType<MechanicalShelly>() || 
                    npc.type == ModContent.NPCType<MechanicalSlimer>() || 
                    npc.type == ModContent.NPCType<MechanicalCreeper>())
                    player.AddBuff(ModContent.BuffType<Frostbite>(), 8 * 60, true);
                if (npc.type == NPCID.DukeFishron && _counter <= 0)
                {
                    Projectile.NewProjectile(npc.GetSource_FromThis(), player.Center, new Vector2(0, 0), ProjectileID.SharknadoBolt, npc.damage, 8);
                    _counter = 60;
                }
            }
        }
        public override void ModifyNPCLoot(NPC npc, NPCLoot npcLoot)
        {
            ...
            if (npc.type == 4)
            {
                _Etheria.OnSuccess(ItemDropRule.Common(ModContent.ItemType<EyeOfEtheria>()));
                npcLoot.Add(_Etheria);
            }
            if (npc.type == 35)
            {
                _Etheria.OnSuccess(ItemDropRule.Common(ModContent.ItemType<EtherialSkull>()));
                npcLoot.Add(_Etheria);
            }
            if (npc.type == 113)
            {
                _Etheria.OnSuccess(ItemDropRule.Common(ModContent.ItemType<EtherialEnergy>()));
                npcLoot.Add(_Etheria);
            }
            if (npc.type == 50)
            {
                _Etheria.OnSuccess(ItemDropRule.Common(ModContent.ItemType<EtherialGel>()));
                npcLoot.Add(_Etheria);
            }
            if (npc.type == NPCID.BrainofCthulhu)
            {
                _Etheria.OnSuccess(ItemDropRule.Common(ModContent.ItemType<BrainOfEtheria>()));
                npcLoot.Add(_Etheria);
            }
            if (npc.type == NPCID.QueenBee)
            {
                _Etheria.OnSuccess(ItemDropRule.Common(ModContent.ItemType<EtherialPack>()));
                npcLoot.Add(_Etheria);
            }
            if (npc.type == NPCID.Golem)
            {
                _Etheria.OnSuccess(ItemDropRule.Common(ModContent.ItemType<StoneOfEtheria>()));
                npcLoot.Add(_Etheria);
            }
            if (npc.type == NPCID.Plantera)
            {
                _Etheria.OnSuccess(ItemDropRule.Common(ModContent.ItemType<EtherialSac>()));
                npcLoot.Add(_Etheria);
            }
            if (npc.type == NPCID.MoonLordCore)
            {
                _Etheria.OnSuccess(ItemDropRule.Common(ModContent.ItemType<EtherialGlobe>()));
                npcLoot.Add(_Etheria);
            }
            if (npc.type == NPCID.TheDestroyer)
            {
                _Etheria.OnSuccess(ItemDropRule.Common(ModContent.ItemType<EtherialDestructionCore>()));
                npcLoot.Add(_Etheria);
            }
            if (npc.type == NPCID.SkeletronPrime)
            {
                _Etheria.OnSuccess(ItemDropRule.Common(ModContent.ItemType<EtherialIllusionCore>()));
                npcLoot.Add(_Etheria);
            }
            if (npc.type == NPCID.DukeFishron)
            {
                _Etheria.OnSuccess(ItemDropRule.Common(ModContent.ItemType<EtherialTruffle>()));
                npcLoot.Add(_Etheria);
            }
        }
        public override void OnKill(NPC npc)
        {
            ...
            if (LaugicalityWorld.downedEtheria)
            {
                if (npc.boss && npc.type != NPCID.EaterofWorldsBody && npc.type != NPCID.EaterofWorldsTail && npc.type != NPCID.EaterofWorldsHead) Item.NewItem(npc.GetSource_FromThis(), (int)npc.position.X, (int)npc.position.Y, npc.width, npc.height, ModContent.ItemType<EtherialEssence>(), Main.rand.Next(5, 11));
                ...
                if (npc.type == 13)
                {
                    ...
                    {
                        Item.NewItem(npc.GetSource_FromThis(), (int)npc.position.X, (int)npc.position.Y, npc.width, npc.height, ModContent.ItemType<EtherialScarf>(), 1);
                        Item.NewItem(npc.GetSource_FromThis(), (int)npc.position.X, (int)npc.position.Y, npc.width, npc.height, ModContent.ItemType<EtherialEssence>(), Main.rand.Next(5, 11));
                ...
                if (npc.type == NPCID.EaterofWorldsHead || npc.type == NPCID.EaterofWorldsBody || npc.type == NPCID.EaterofWorldsTail)
                {
                    if (Main.rand.Next(6) == 0 && Main.netMode != 1)
                        NPC.NewNPC(npc.GetSource_FromThis(), (int)npc.Center.X, (int)npc.Center.Y, ModContent.NPCType<SuperCorruptor>());
                }

                if (npc.type == 125 && NPC.CountNPCS(126) == 0 || npc.type == 126 && NPC.CountNPCS(125) == 0)
                {
                    Item.NewItem(npc.GetSource_FromThis(), (int)npc.position.X, (int)npc.position.Y, npc.width, npc.height, ModContent.ItemType<EtherialConjurationCore>(), 1);
        ...
        public override bool? CanChat(NPC npc)
        {
            if (LaugicalityWorld.downedEtheria)
            {
                if (npc.type == NPCID.ScorpionBlack && LaugicalityPlayer.Get().EtherVision)
                    return true;
                if (LaugicalityPlayer.Get().EtherVision)

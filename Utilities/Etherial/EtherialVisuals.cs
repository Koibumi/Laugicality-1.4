...
namespace Laugicality.Utilities.Etherial
{
    ...
    public class EtherialVisual : CustomSky
    {
        ...
        public override void Draw(SpriteBatch spriteBatch, float minDepth, float maxDepth)
        {
            if (maxDepth >= 0 && minDepth < 0)
            {
                ...
                spriteBatch.Draw(TextureAssets.BlackTile.Value, new Rectangle(0, 0, Main.screenWidth, Main.screenHeight), new Color(0, 19, 77) * intensity); //Tints the background (RGB)
            }
        }

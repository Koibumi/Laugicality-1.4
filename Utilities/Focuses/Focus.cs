...
{
    public abstract class Focus : ModSystem, ILocalizedModType, IHasUnlocalizedName
    {
        public string UnlocalizedName { get; }
        public string LocalizationCategory => "AntiarisWorldSystem";

        public override void Load()
        {
            string Focuses = this.GetLocalization("Items.Focuses").Value;
        }

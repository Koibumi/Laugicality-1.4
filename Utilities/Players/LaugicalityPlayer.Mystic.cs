    ...
    public sealed partial class LaugicalityPlayer
    {
        ...
        public void MysticSwitch()
        {
            ...
            if (MysticSwitchCool <= 0 && !MysticBurstDisabled)
            {
                ...
                {
                    Projectile.NewProjectile(Player.GetSource_FromThis(), Player.Center.X, Player.Center.Y, 2.5f, -6.25f, ModContent.ProjectileType<ShroomBurst>(), (int)(10 * MysticDamage * MysticBurstDamage), 3, Main.myPlayer);
                    Projectile.NewProjectile(Player.GetSource_FromThis(), Player.Center.X, Player.Center.Y, 5, -5, ModContent.ProjectileType<ShroomBurst>(), (int)(10 * MysticDamage * MysticBurstDamage), 3, Main.myPlayer);
                    Projectile.NewProjectile(Player.GetSource_FromThis(), Player.Center.X, Player.Center.Y, -5, -5, ModContent.ProjectileType<ShroomBurst>(), (int)(10 * MysticDamage * MysticBurstDamage), 3, Main.myPlayer);
                    Projectile.NewProjectile(Player.GetSource_FromThis(), Player.Center.X, Player.Center.Y, -2.5f, -6.25f, ModContent.ProjectileType<ShroomBurst>(), (int)(10 * MysticDamage * MysticBurstDamage), 3, Main.myPlayer);
                    Projectile.NewProjectile(Player.GetSource_FromThis(), Player.Center.X, Player.Center.Y, 2.5f / 2, -6.75f, ModContent.ProjectileType<ShroomBurst>(), (int)(10 * MysticDamage * MysticBurstDamage), 3, Main.myPlayer);
                    Projectile.NewProjectile(Player.GetSource_FromThis(), Player.Center.X, Player.Center.Y, 3.75f, -5.75f, ModContent.ProjectileType<ShroomBurst>(), (int)(10 * MysticDamage * MysticBurstDamage), 3, Main.myPlayer);
                    Projectile.NewProjectile(Player.GetSource_FromThis(), Player.Center.X, Player.Center.Y, -3.75f, -5.75f, ModContent.ProjectileType<ShroomBurst>(), (int)(10 * MysticDamage * MysticBurstDamage), 3, Main.myPlayer);
                    Projectile.NewProjectile(Player.GetSource_FromThis(), Player.Center.X, Player.Center.Y, -2.5f / 2, -6.75f, ModContent.ProjectileType<ShroomBurst>(), (int)(10 * MysticDamage * MysticBurstDamage), 3, Main.myPlayer);
                ...
                if (MysticSandBurst)
                {
                    Projectile.NewProjectile(Player.GetSource_FromThis(), Player.Center.X, Player.Center.Y + 16, 2, 0, ModContent.ProjectileType<AncientRune>(), (int)(12 * MysticDamage * MysticBurstDamage), 3, Main.myPlayer);
                    Projectile.NewProjectile(Player.GetSource_FromThis(), Player.Center.X, Player.Center.Y + 16, -2, 0, ModContent.ProjectileType<AncientRune>(), (int)(12 * MysticDamage * MysticBurstDamage), 3, Main.myPlayer);
                ...
                {
                    Projectile.NewProjectile(Player.GetSource_FromThis(), Player.Center.X, Player.Center.Y + 16, 4, 0, ModContent.ProjectileType<EruptionBurst>(), (int)(12 * MysticDamage * MysticBurstDamage), 3, Main.myPlayer);
                    Projectile.NewProjectile(Player.GetSource_FromThis(), Player.Center.X, Player.Center.Y + 16, -4, 0, ModContent.ProjectileType<EruptionBurst>(), (int)(12 * MysticDamage * MysticBurstDamage), 3, Main.myPlayer);
                    MysticErupting += 45;
                ...
                if (MysticObsidiumBurst)
                {
                    ...
                    for (int i = 0; i < 16; i++)
                    {
                        ...
                        Projectile.NewProjectile(Player.GetSource_FromThis(), Player.Center.X, Player.Center.Y, mag * (float)Math.Cos(theta), mag * (float)Math.Sin(theta), ModContent.ProjectileType<ObsidiumMysticBurst>(), (int)(24 * MysticDamage * MysticBurstDamage), 3, Main.myPlayer);
                    }

        ...
        public override void AI()
        {
            if(origin.X == 0)
            {
                ...
                if (Main.myPlayer == Projectile.owner)
                    Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.position.X, Projectile.position.Y, Projectile.velocity.X, Projectile.velocity.Y, ModContent.ProjectileType<WarlockStaff2>(), Projectile.damage, 3, Main.myPlayer);
            }
            bitherial = true;

        ...
        public override void AI()
        {
            ...
            if(_delay > 20)
            {
                ...
                if (Main.myPlayer == Projectile.owner)
                    Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, -Projectile.velocity.X / 4, -Projectile.velocity.Y / 4, ModContent.ProjectileType<TrueEtherialPulsar>(), (int)(Projectile.damage), 3, Main.myPlayer);
            }
            if(_spawned >=5)
                Projectile.Kill();
        }

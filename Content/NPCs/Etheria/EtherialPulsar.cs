...
{
	public class EtherialPulsar : ModProjectile
	{
        public int delay = 0;
        public int damage = 0;
        ...
        public override void AI()
        {
            ...
            {
                Projectile.NewProjectile(source, Projectile.Center.X, Projectile.Center.Y, 7, 0, ModContent.ProjectileType<EtherialPulse>(), damage, 3f, Main.myPlayer);
                Projectile.NewProjectile(source, Projectile.Center.X, Projectile.Center.Y, -7, 0, ModContent.ProjectileType<EtherialPulse>(), damage, 3f, Main.myPlayer);
                Projectile.NewProjectile(source, Projectile.Center.X, Projectile.Center.Y, 0, -7, ModContent.ProjectileType<EtherialPulse>(), damage, 3f, Main.myPlayer);
                Projectile.NewProjectile(source, Projectile.Center.X, Projectile.Center.Y, 0, 7, ModContent.ProjectileType<EtherialPulse>(), damage, 3f, Main.myPlayer);
                Projectile.NewProjectile(source, Projectile.Center.X, Projectile.Center.Y, 5, 5, ModContent.ProjectileType<EtherialPulse>(), damage, 3f, Main.myPlayer);
                Projectile.NewProjectile(source, Projectile.Center.X, Projectile.Center.Y, 5, -5, ModContent.ProjectileType<EtherialPulse>(), damage, 3f, Main.myPlayer);
                Projectile.NewProjectile(source, Projectile.Center.X, Projectile.Center.Y, -5, -5, ModContent.ProjectileType<EtherialPulse>(), damage, 3f, Main.myPlayer);
                Projectile.NewProjectile(source, Projectile.Center.X, Projectile.Center.Y, -5, 5, ModContent.ProjectileType<EtherialPulse>(), damage, 3f, Main.myPlayer);
                Projectile.Kill();

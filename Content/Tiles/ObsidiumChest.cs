...
{
    public class ObsidiumChest : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(200, 100, 0), this.GetLocalization("MapEntry0"), MapChestName);
            AddMapEntry(new Color(200, 100, 0), this.GetLocalization("MapEntry1"), MapChestName);
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            else
            {
                ...
                {
                    player.cursorItemIconID = ModContent.ItemType<Items.Placeable.ObsidiumChest>();

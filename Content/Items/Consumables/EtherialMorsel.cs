...
namespace Laugicality.Content.Items.Consumables
{
	public class EtherialMorsel : LaugicalityItem
    {
        ...
        {
            Projectile.NewProjectile(source, position.X, position.Y, speed.X, speed.Y, ModContent.ProjectileType<GeneralBossSpawn>(), ModContent.NPCType<DuneSharkron>(), knockback, player.whoAmI);
            return false;
        }

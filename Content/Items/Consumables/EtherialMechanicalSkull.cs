...
{
	public class EtherialMechanicalSkull : LaugicalityItem
    {
        ...
        {
            Projectile.NewProjectile(source, position.X, position.Y, speed.X, speed.Y, ModContent.ProjectileType<GeneralBossSpawn>(), NPCID.SkeletronPrime, knockback, player.whoAmI);
            return false;
        }

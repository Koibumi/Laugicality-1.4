...
namespace Laugicality.Content.Items.Consumables
{
	public class EtherialEye : LaugicalityItem
    {
        ...
        {
            Projectile.NewProjectile(source, position.X, position.Y, speed.X, speed.Y, ModContent.ProjectileType<GeneralBossSpawn>(), NPCID.EyeofCthulhu, knockback, player.whoAmI);
            return false;
        }

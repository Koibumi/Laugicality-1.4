...
{
	public class EtherialCrown : LaugicalityItem
    {
        ...
        {
            Projectile.NewProjectile(source, position.X, position.Y, speed.X, speed.Y, ModContent.ProjectileType<GeneralBossSpawn>(), NPCID.KingSlime, knockback, player.whoAmI);
            return false;
        }
        ...
        public override void AddRecipes()
		{
            ...
            recipe.AddIngredient(ModContent.ItemType<EtherialEssence>());

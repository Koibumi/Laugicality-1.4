...
namespace Laugicality.Content.Items.Consumables
{
	public class MoltenMess : LaugicalityItem
    {
        ...
        {
            Projectile.NewProjectile(source, position.X, position.Y, speed.X, speed.Y, ModContent.ProjectileType<GeneralBossSpawn>(), ModContent.NPCType<Ragnar>(), knockback, player.whoAmI);
            return false;
        }

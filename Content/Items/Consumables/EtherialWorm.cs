...
namespace Laugicality.Content.Items.Consumables
{
	public class EtherialWorm : LaugicalityItem
    {
        ...
        {
            Projectile.NewProjectile(source, position.X, position.Y, speed.X, speed.Y, ModContent.ProjectileType<GeneralBossSpawn>(), NPCID.TheDestroyer, knockback, player.whoAmI);
            return false;
        }

...
namespace Laugicality.Content.Items.Consumables
{
	public class EtherialMesh : LaugicalityItem
    {
        ...
        {
            Projectile.NewProjectile(source, position.X, position.Y, speed.X, speed.Y, ModContent.ProjectileType<GeneralBossSpawn>(), ModContent.NPCType<Hypothema>(), knockback, player.whoAmI);
            return false;
        }

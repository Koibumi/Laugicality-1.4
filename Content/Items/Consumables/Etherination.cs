...
namespace Laugicality.Content.Items.Consumables
{
	public class Etherination : LaugicalityItem
    {
        ...
        {
            Projectile.NewProjectile(source, position.X, position.Y, speed.X, speed.Y, ModContent.ProjectileType<GeneralBossSpawn>(), NPCID.QueenBee, knockback, player.whoAmI);
            return false;
        }

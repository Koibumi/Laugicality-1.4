...
namespace Laugicality.Content.Items.Consumables
{
	public class EtherialWormFood : LaugicalityItem
    {
        ...
        {
            Projectile.NewProjectile(source, position.X, position.Y, speed.X, speed.Y, ModContent.ProjectileType<GeneralBossSpawn>(), NPCID.EaterofWorldsHead, knockback, player.whoAmI);
            return false;
        }

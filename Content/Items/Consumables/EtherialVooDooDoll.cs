...
namespace Laugicality.Content.Items.Consumables
{
	public class EtherialVooDooDoll : LaugicalityItem
    {
        ...
        {
            Projectile.NewProjectile(source, position.X, position.Y, speed.X, speed.Y, ModContent.ProjectileType<GeneralBossSpawn>(), NPCID.WallofFlesh, knockback, player.whoAmI);
            return false;
        }
